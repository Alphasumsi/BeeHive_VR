...
public partial class SettingsPage : UserControl
{
    ...
    private void OpenConfigsFolder_Click(object sender, RoutedEventArgs e)
        => System.Diagnostics.Process.Start(new System.Diagnostics.ProcessStartInfo
        { FileName = HoneyOverlays.Services.ConfigPaths.ConfigsFolder, UseShellExecute = true });

    private void OpenLogFolder_Click(object sender, RoutedEventArgs e)
    {
        var folder = System.IO.Path.GetDirectoryName(HoneyOverlays.Services.Logger.LogFilePath);
    ...
    private void DevThrow_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            HoneyOverlays.Services.Logger.Error("DevThrow_Click test", ex);
    ...
    private void DevReloadConfigs_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            mvm.LoadFromDisk();
            HoneyOverlays.Services.Logger.Info("Configs reloaded from disk (Dev)");
        }
    }
    ...
    private void DevOpenSettingsFile_Click(object sender, RoutedEventArgs e)
    {
        ...
        var folder = System.IO.Path.Combine(appData, HoneyOverlays.Services.Logger.AppDataFolderName);
    ...
    private void DevResetSettings_Click(object sender, RoutedEventArgs e)
    {
                ...
                "Reset", "Cancel"))
        {
            ...
            HoneyOverlays.Services.Logger.Info("Settings reset to defaults (Dev)");
        }
    }
