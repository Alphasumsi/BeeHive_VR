...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        var icon = new System.Windows.Media.Imaging.BitmapImage(
            new System.Uri(HoneyOverlays.Services.AppEdition.IconPackUri));
        Icon = icon;
    ...
    private void MainWindow_StateChanged(object? sender, System.EventArgs e)
    {
        ...
        var s = HoneyOverlays.Services.SettingsStore.Current;
        if (WindowState == WindowState.Minimized && s.StartInTray)
        {
            Hide();
            ShowInTaskbar = false;
            HoneyOverlays.Services.TrayIconService.Instance.Show();
        }
    ...
    private void SaveWindowStateIfEnabled()
    {
        ...
        HoneyOverlays.Services.SettingsStore.Save();
    }
