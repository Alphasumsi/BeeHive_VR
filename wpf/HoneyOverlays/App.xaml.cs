...
#if LITE
            // Lite-Edition: eigene Hintergrundfarbe zur Unterscheidung von der
            // Vollversion. Muss VOR dem MainWindow-Aufbau passieren, damit die
            // StaticResource-Lookups in Fenster + Pages den neuen Wert ziehen.
            Resources["BgPrimary"] = new System.Windows.Media.SolidColorBrush(
                (System.Windows.Media.Color)System.Windows.Media.ColorConverter.ConvertFromString("#260c07"));
#endif
