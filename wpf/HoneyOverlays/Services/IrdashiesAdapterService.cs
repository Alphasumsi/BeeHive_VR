...
public sealed class IrdashiesAdapterService
{
    ...
    private const string MockSessionResource   = "HoneyOverlays.Assets.MockData.session.json";
    private const string MockTelemetryResource = "HoneyOverlays.Assets.MockData.telemetry.json";
    ...
    // DashboardLayout kommt jetzt aus dem Honey-eigenen Store (liest/schreibt,
